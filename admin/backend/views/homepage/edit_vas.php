<div id="box">
                	<h3 id="adduser">Edit Frontend VAS list</h3>
                    <form id="form" action="<?=$site_url.$active_controller.'/editvas/'.$id?>" method="post">
                      <fieldset id="personal">
                        ...
                        <input name="order" id="order"  class ='text' type="text" tabindex="3" value="<?=set_value('order',$order) ?>" style='width:50px;' />
                        <br />
                        <label for="id_content">Content : </label>
                        <select name='id_content' id='id_content' tabindex='4'>
                        <option value=''>-----No content----</potion>
                       	 <?php echo html_options($content_option,set_value('id_content',$id_content)) ?></select><span class='req'>*</span> <?php echo form_error('id_content'); ?>
                        <br />
                      ...
                      <div align="center">
                      <input id="button1" type="submit" value="Edit" abindex="9" /> 
