<div id="box">
                	<h3 id="adduser">Create New User</h3>
                    <form id="form" action="<?=$site_url.$active_controller?>/add" method="post">
                      <fieldset id="personal">
                    	...
                    	<?php echo html_menu_options($menu_tree,set_value('parent_id')) ?>
                         </select>
                        <br />
                        <label for="order">Order : </label>
                        <input name="order" id="order"  class ='text' type="text" tabindex="3" value="<?=set_value('order') ?>" style='width:50px;' /><span class='req'>*</span> <?php echo form_error('order'); ?>
                        <br />
                        <label for="id_content">Content : </label>
                        <select name='id_content' id='id_content' tabindex='4'>
                        <option value='0'>-----No content----</potion>
                       	 <?php echo html_options($content_option,set_value('id_content')) ?></select>
                        <br />
                      ...
                      <fieldset id="controller-method">
                        ...
                        <input name="module_link" id="module_link" type="text"  class="text" tabindex="8" value="<?=set_value('module_link') ?>" />
